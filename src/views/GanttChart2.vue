...
<template>
    <div
        ...
        <div
            ...
            <div v-for="gantt_chart in ganttCharts" :key="gantt_chart.id" @click="select_schedule(gantt_chart || [])"
                :class="[
                ...
                <p class="text-gray-600 text-sm">Description or additional info here.</p>
            </div>
        </div>
                ...
                <div class="flex flex-col md:flex-row gap-4 text-gray-700 bg-white shadow-lg">
                    <h4 @click="setActiveTab('schedules')"
                        class="font-semibold text-base cursor-pointer transition-colors duration-200 pb-2" :class="{
                            'text-blue-500 border-b-2 border-blue-500': activeTab === 'schedules',
                            'text-gray-500 border-b-2 border-transparent': activeTab !== 'schedules',
                        }">
                        Schedules
                    </h4>
                    <h4 @click="setActiveTab('gantt')"
                        class="font-semibold text-base cursor-pointer transition-colors duration-200 pb-2" :class="{
                            ...
                            'text-gray-500 border-b-2 border-transparent': activeTab !== 'gantt',
                        }">
                        Gantt Chart
                    </h4>
                    <h4 @click="setActiveTab('calendar')"
                        class="font-semibold text-base cursor-pointer transition-colors duration-200 pb-2" :class="{
                            'text-blue-500 border-b-2 border-blue-500': activeTab === 'calendar',
                            'text-gray-500 border-b-2 border-transparent': activeTab !== 'calendar',
                        }">
                        Calendar
                    </h4>
                </div>
